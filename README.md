...
- `data/full_answer_audit.csv` 全量答案审计表（含来源与变更）
- `data/full_answer_audit.md` 全量答案审计表（Markdown版）

## 答案来源说明
- `official`：官方答案（200题，判断1-50 + 单选1-150）
- `verified_web`：可关联互联网权威资料的答案（训练用途）
- `inferred`：第一性原理推断答案（训练用途）
